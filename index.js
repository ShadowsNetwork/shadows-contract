...
const getSuspensionReasons = ({ code = undefined } = {}) => {
	const suspensionReasonMap = {
		1: 'System Upgrade',
		2: 'Market Closure',
		55: 'Circuit Breaker (Phase one)', // https://sips.shadows.io/SIPS/sip-55
		65: 'Decentralized Circuit Breaker (Phase two)', // https://sips.shadows.io/SIPS/sip-65
		99999: 'Emergency',
	};
...
/**
 * Retrieve the list of tokens used in the Shadows protocol
 */
