...
**Source:** [Proxyable.sol](https://github.com/Shadowsio/shadows/blob/master/contracts/Proxyable.sol)
...
In the case of the [`Shadows`](Shadows.md) contract, this integrationProxy is an instance of the [ERC20 proxy](ProxyERC20.md).
