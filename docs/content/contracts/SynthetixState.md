...
This is used by [`Shadows._addToDebtRegister`](Shadows.md#addtodebtregister) contract whenever Synths are issued or burnt, which modifies the total outstanding system debt.
