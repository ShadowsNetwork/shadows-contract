...
The main [`Shadows`](Shadows.md) contract and all [`Synths`](Synth.md) are ExternStateTokens.

**Source:** [ExternStateToken.sol](https://github.com/Shadowsio/shadows/blob/master/contracts/ExternStateToken.sol)
...
The ERC20 decimal precision of this token. This is usually set to 18 in Shadows.
